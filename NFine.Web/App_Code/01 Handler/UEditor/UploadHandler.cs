...
public class UploadHandler : Handler
{
    ...
    public override void Process()
    {
        ...
        if (UploadConfig.Base64)
        {
            ...
            uploadFileBytes = Convert.FromBase64String(HttpContext.Current.Request.Query[UploadConfig.UploadFieldName]);
        }
        else
        {
            var file = HttpContext.Current.Request.Form.Files[UploadConfig.UploadFieldName]; //Request.Files[UploadConfig.UploadFieldName];
